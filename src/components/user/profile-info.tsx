    ...
    <Card className="shadow-lg border-slate-200 dark:border-slate-700">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-semibold text-slate-700 dark:text-slate-300 mb-3">Basic Information</h4>
          ...
          <div>
            <h4 className="font-semibold text-slate-700 dark:text-slate-300 mb-3">Account Status</h4>
            <div className="space-y-3">
              <div className="flex justify-between">
                <span className="text-slate-600 dark:text-slate-400">Plan:</span>
                <Badge 
                  variant={user.plan === "premium" ? "default" : "secondary"}
                  className={user.plan === "premium" ? "bg-gradient-to-r from-yellow-500 to-orange-500" : ""}
                >
                  {user.plan || "free"}
                </Badge>
              </div>
              ...
              {user.premiumExpiresAt && (
                <div className="flex justify-between">
                  <span className="text-slate-600 dark:text-slate-400">Premium until:</span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium max-w-xs text-right">
                      {user.metadata?.website ? (
                        <a 
                          href={user.metadata.website.startsWith('http') ? user.metadata.website : `https://${user.metadata.website}`}
                          target="_blank"
