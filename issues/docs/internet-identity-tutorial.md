...
Navigate into the folder containing the project's files, start a local instance of the Internet Computer, and create a new project with the commands:
...
## Step 9: Run `dfx deploy` again

This will also regenerate the bindings in `src/declarations`.
